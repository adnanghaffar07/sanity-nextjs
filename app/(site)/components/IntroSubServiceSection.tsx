...
const IntroductionSubSection: React.FC<IntroductionSectionProps> = ({ data }) => {
  ...
  return (
    ...
    <div className="container mx-auto flex flex-wrap items-center justify-center">
      {sectionData.introductionSubSection?.introImage ? (
        <div className="w-full md:w-1/2 md:flex md:pl-8 md:justify-start mb-4">
          <Image
            src={urlForImage(sectionData.introductionSubSection?.introImage).toString()}
            alt=""
            width={570}
            height={370}
          />
        ...
        <div className="w-full  justify-center mb-4">
          <div className="max-w-2xl">
            <h2 className="text-3xl font-bold mb-8 text-center">
              {sectionData.introductionSubSection?.introHeading}
            </h2>
            <p className="text-lg text-gray-800 leading-relaxed text-center ">
              {sectionData.introductionSubSection?.introDesc}
            </p>
          </div>
          {sectionData.pdfFile && (
...
export default IntroductionSubSection;
