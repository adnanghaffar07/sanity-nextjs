  ...
  return (
    <Slider {...swiperSettings}>
      <div>
        ...
        <div
          className="lg:text-2xl text-base text-center mt-5 xl:mt-10 max-md:max-w-full"
      ...
      <div>
        ...
        <div
          className="lg:text-2xl text-base text-center mt-5 xl:mt-10 xl:max-w-[1100px] 2xl:max-w-[1200px] xl:mx-auto"
          style={{ lineHeight: "1.6" }}
        >
