    ...
    <div className="container mx-auto flex flex-wrap items-center justify-center">
        ...
        <div className={data.introductionSubSection?.introImage ? "w-full md:w-1/2 md:justify-end" : "w-full"}>
             ...
             <section className="px-6 md:px-16 py-10 md:py-16 bg-white">
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                    ...
                    <div className="col-span-1 md:col-span-1 ml-4 md:ml-24"> {/* Adjusted margin */}
                        <div>
                            <h2 className="text-2xl font-bold mb-8 text-gray-800">{data.projectCycleSubSection?.projectCycleHaeding}</h2>
            ...
            <section className="bg-white px-6 md:px-16 py-10 md:py-16">
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 items-center ">
                    ...
                    <div className="text-right mr-4 md:mr-24">
                        <h2 className="text-2xl font-bold mb-8">{data.deliveryOptionSubSection?.deliveryOptionHaeding}</h2>
                ...
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="bg-white shadow-md p-6 rounded-lg">
                            <p className="text-lg font-semibold mb-4">{data.specialOffersSubSection?.specialOffer}</p>
                        </div>
                    </div>
                    {/* Right side (Content) */}
                    <div className="col-span-1 md:col-span-1 flex justify-center">
            ...
            <section className="bg-white px-6 md:px-16 py-10 md:py-16">
                ...
                <div className="container mx-auto">
                    <h2 className="text-2xl font-bold mb-8 text-center">{data.summarySubSection?.summaryHeading}</h2>
                    <p className="text-lg text-center">{data.summarySubSection?.summaryMessage}</p>
                </div>
            </section>
