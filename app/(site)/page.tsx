        ...
        <div className="max-w-full mx-auto relative">
          ...
          <div className="flex flex-col bg-[#F3F3F3] py-16 relative  overflow-hidden">
            ...
            <ScrollAnimation>
              ...
              <p className="self-center md:mt-6 mt-3 lg:text-xl text-lg text-center text-black max-w-4xl mx-auto">
