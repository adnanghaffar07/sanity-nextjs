...
const StatItem = ({ imageSrc, text }: { imageSrc: string; text: string }) => (
  <div className="flex flex-col py-4 text-lg font-light leading-6  text-center w-[290px] xl:w-[270px] 2xl:w-[270px] h-[220px] transition-shadow ease-in-out duration-500">
    <img
      ...
      src={imageSrc}
      alt="icon"
      className="self-center aspect-square w-14 xl:w-[70px] 2xl:w-[70px]"
    />
  ...
  return (
    <div>
          ...
          <div className="relative z-10">
            <div className="max-w-[1920px] mx-auto">
              <div className="flex flex-col items-center justify-center text-center mb-6">
                <h2 className="text-2xl md:text-4xl font-semibold mb-4">Why We&apos;re Trusted by Industry Leaders</h2>
                <h3 className="text-lg md:text-2xl font-medium max-w-4xl text-[#3C3C3C]">
                  Businesses trust us for our top-notch software development services, proven expertise, and reliable solutions tailored to their needs
                </h3>
              </div>
              ...
              <div className="flex gap-14 flex-wrap justify-center">
                {stats.map((stat, index) => (
                  ...
                  >
                    <StatItem imageSrc={stat.imageSrc} text={stat.text} />
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="max-w-full mx-auto relative max-w-[1920px]">
        ...
        />
        <ScrollAnimation>
          <div className="flex flex-col self-center mt-16 w-full mx-auto max-md:mt-10 max-md:max-w-full">
                ...
                <div className="flex flex-col w-[58%] max-md:ml-0 max-md:w-full self-center">
                  <div className="flex flex-col text-black max-md:mt-10 max-md:max-w-full">
                    ...
                    <h2 className="text-xl font-medium text-left mt-12 ">
                      Partner with us to access unmatched expertise and support in these areas, empowering your business with advanced technologies and driving your growth to new heights.
                    </h2>
        ...
        <div className="relative flex justify-center items-center py-10 max-w-[1624px] mx-auto px-6 lg:px-10">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg xl:text-xl text-gray-600 text-center max-w-4xl mx-auto mb-16">
              Over years of experience, we know that all businesses work within a specific software and hardware setup. We offer a wide range of software development services that are available to suit the specific requirements for your product. Check out our services below.            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 text-left px:6 md:px-16 ">
              <div className="flex bg-white p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
                <div className="mr-6 flex-shrink-0">
                  <img src="/end-to-end-1.png" alt="Custom Software Icon" className="w-16 h-16" />
                </div>
                <div>
                  <h3 className="text-2xl font-semibold mb-2">Custom Software Development</h3>
                  <p className="text-lg text-gray-700">
                    Custom Software Solutions To Power Innovation And Efficiency In Your Business.
                  </p>
                </div>
              </div>
              ...
              <div className="flex bg-white p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
                <div className="mr-6 flex-shrink-0">
                  <img src="end-to-end-2.png" alt="Offshore Software Icon" className="w-16 h-16" />
                </div>
                <div>
                  <h3 className="text-2xl font-semibold mb-2">Offshore Software Development</h3>
                  <p className="text-lg text-gray-700">
                    Ensure premium results, coupled with seamless project management by the leverage of cost-effective offshore development services to hire top global talent.
                  </p>
                </div>
              </div>
              ...
              <div className="flex bg-white p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
                <div className="mr-6 flex-shrink-0">
                  <img src="end-to-end-3.png" alt="Enterprise Software Icon" className="w-16 h-16" />
                </div>
                <div>
                  <h3 className="text-2xl font-semibold mb-2">Enterprise Software Development</h3>
                  <p className="text-lg text-gray-700">
                    Scalable, secure enterprise solutions that enhance productivity and support complex business operations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex bg-white p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
                <div className="mr-6 flex-shrink-0">
                  <img src="/end-to-end-4.png" alt="Software Integration Icon" className="w-16 h-16" />
                </div>
                <div>
                  <h3 className="text-2xl font-semibold mb-2">Software Integration</h3>
                  <p className="text-lg text-gray-700">
                    Software application alignment with a single point-to-point connection removing data silos and optimizing business workflow
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mx-auto flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="lg:w-[50%]">
                ...
                <p className="xl:mt-11 lg:text-xl text-base font-light mt-5 max-md:max-w-full tracking-normal">
                  Founded in 2015, we are a leading IT software development company specializing in crafting and managing high-performing remote software engineering teams. Since our inception, we have dedicated ourselves to delivering tailored software solutions and exceptional service to our clients. Our commitment to excellence and innovation drives our mission to empower businesses with cutting-edge technology and reliable support.
                  <br />
                  <br />
                  We are a high-performing IT Software Development Company founded in 2015 and we build & manage dedicated software development teams, which is based on your specific business needs. From day one, we have committed to delivering custom software solutions and exceptional service way beyond the industry standard. Our commitment to excellence and innovation, pushing us to not only help businesses grow with the true cutting-edge technology but also ensuring that we source/develop products/applications through thorough R&D providing cutting-edge technology and reliable support.
                </p>
              </div>
            ...
            <div className="justify-center text-center relative z-10 pb-10">
              <div>
                ...
                <p className=" justify-center text-center text-lg font-medium text-[#3C3C3C] mx-auto max-w-4xl">
                  Outsource with us for real experience in custom software development
                  and top-line software solutions that will bring innovative results to
                  your business.
                </p>
              </div>
            </div>
        ...
        <div
          className="w-full px-6 py-10 md:px-16 md:py-20 rounded-lg shadow-lg flex flex-col md:flex-row items-center text-white"
          style={{
        ...
        <ScrollAnimation>
          <div className="flex flex-col self-center w-full mx-auto max-md:max-w-full lg:py-16 py-16 lg:px-10 px-5">
            ...
            <p className="lg:mt-8 mt-4 text-xl font-light text-center text-black lg:px-10 md:px-5 max-w-[1582px] mx-auto">
              Explore the impactful results of our expertise in software development. Each project in our portfolio reflects our commitment to excellence. Discover how we&rsquo;ve
              driven success for businesses like yours through our detailed case studies.
            </p>
              ...
              <div className="flex flex-col w-[58%] max-md:ml-0 max-md:w-full self-center md:px-4">
                <div className="flex flex-col text-black max-md:mt-10 max-md:max-w-full">
                  ...
                  <div className="xl:mt-11 lg:text-xl text-base font-light mt-5 max-md:max-w-full xl:pr-36 tracking-normal">
                    <p>
                      At CodeAutomation, we blend collaboration, creativity, and precision to deliver exceptional results. Our unique project execution combines advanced technology with a personal touch, driven by our certified experts. We focus on crafting innovative solutions that empower businesses to achieve their growth objectives in the digital age.                        <br />
                      <br />
                      Here at CodeAutomation, we mix collaboration with creativity and precision to achieve remarkable results. Business Excellence- Our efficient project execution uses a mix of high-end technology combined with the human touch; driven by our certified experts. We focus on crafting innovative solutions that empower businesses to achieve their growth objectives in the digital age.                      </p>
                  </div>
                  <div className="flex items-start self-stretch pr-8 text-base xl:text-xl lg:text-lg font-medium whitespace-nowrap max-w-[450px] max-md:pr-5 mt-12">
                    <Link
                      href="/services"
          ...
          <ScrollAnimation>
            <div className="relative z-10 flex flex-col items-center">
              ...
              <p className="self-center md:mt-6 mt-3 lg:text-xl text-lg text-center text-white max-w-4xl mx-auto">
                Let us show you how our services have helped clients with custom software development. These client reviews will tell you why our amazing solutions & support set us apart.
              </p>
            </div>
