...
export default function CareerSub() {
  return (
    <div>
      <div className="flex overflow-hidden relative flex-col pb-12 w-full font-light text-white lg:min-h-[600px] max-md:max-w-full bg-cover bg-no-repeat bg-left-top"
      style={{
        backgroundImage: `url(/img-career-sub-intro-banner.jpg)`
        }}
          ...
          <div className="flex flex-col self-center w-full xl:max-w-[1582px] relative z-10 mx-auto">
            <div className="lg:px-10 px-5 w-full py-16">
              ...
              <div className='mb-10'>
                ...
                <div className=''>
                  <ul className='list-disc text-xl font-light mb-5 pl-5'>
              ...
              <div className='mb-5'>
                <div className="cursor-pointer inline-flex gap-2 items-center relative">
