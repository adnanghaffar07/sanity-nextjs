import section from "@/sanity/schemas/section-schema";
import React from "react";

const page = () => {
  return (
    <section className="mt-44 max-w-4xl mx-auto px-6 py-10 bg-white shadow-md rounded-lg mb-10">
      <h1 className="text-center text-4xl font-bold mb-6">
        Terms and Conditions
      </h1>
      <p className="text-gray-600 mb-4">Last updated: August 23, 2024</p>
      ...
      <ul className="list-disc list-inside text-gray-700 mb-6">
        ...
        <li className="mb-2">
          ...
          this Agreement) refers to Code Automation AI, Chicago.
        </li>
        <li className="mb-2">
      ...
      <ul className="list-disc list-inside text-gray-700 mb-6">
        <li className="mb-2">By email: info@codeautomation.ai</li>
        <li className="mb-2">
